...
// src/app/services/travel-data.service.ts
var TravelDataService;
var init_travel_data_service = __esm({
  "src/app/services/travel-data.service.ts"() {
    "use strict";
    init_tslib_es6();
    init_core();
    TravelDataService = class TravelDataService2 {
      locations = [
        {
          id: "maldives",
          name: "Maldives",
          ...
          mappingDetails: [
            {
              ...
              fullDescription: "Maafushi is one of the most popular local islands in the Maldives, offering a perfect blend of affordability and tropical beauty. Unlike the private resort islands, Maafushi gives travelers a chance to experience authentic Maldivian culture while enjoying activities like snorkeling, diving, jet skiing, and sandbank trips. With plenty of guesthouses and beachside caf\xE9s, it\u2019s an ideal destination for backpackers and budget travelers who want the paradise experience without breaking the bank."
            },
            {
              mappingId: "male",
              mapname: "MALE",
            ...
            },
            {
              ...
              fullDescription: "Hulhumale is a reclaimed island connected to Male and the international airport, designed to ease travel and urban crowding. It's a convenient base for travelers arriving or departing, offering modern hotels, beach access, caf\xE9s, and sunset views. While not as remote or luxurious as other islands, Hulhumale provides a clean and peaceful atmosphere with easy access to the rest of the Maldives."
            },
            {
              mappingId: "vaadhoo",
      ...
      getHotelPhotoLabels(destinationId, day) {
      ...
      getLocationById(id) {
        return this.locations.find((location) => location.id.toLowerCase() === id.toLowerCase()) || this.trendylocations.find((location) => location.id.toLowerCase() === id.toLowerCase()) || null;
      }
      getAllLocations() {
        return [...this.locations, ...this.trendylocations];
      }
    };
    TravelDataService = __decorate([
      Injectable({
        providedIn: "root"
      })
    ], TravelDataService);
...
//# sourceMappingURL=chunk-5SDFLPWZ.js.map
